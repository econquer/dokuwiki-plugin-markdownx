...
class syntax_plugin_markdownx_imagesinline extends DokuWiki_Syntax_Plugin {
    ...
    function connectTo($mode) {
        ...
        $this->Lexer->addSpecialPattern('\!\['.$this->nested_brackets_re.'\]\([ \t]*<?.+?>?[ \t]*(?:[\'"].*?[\'"])?\)', $mode, 'plugin_markdownx_imagesinline');
    }
